...
The module is currently hosted on the [5Genesis GitLab](https://gitlab.fokus.fraunhofer.de/5genesis/analytics) and requires access to this repository.
...
5. Download analytics-stack.yaml from this repository.

6. Deploy Docker images to Swarm from the location where the analytics-stack.yaml file is located:
    ```bash
...
- KPI Prediction using different algorithms: [http://localhost:5002/predict/datasource/algorithm/target](http://localhost:5002/predict/datasource/algorithm/target)
    + Algorithm:
...
<!--Example: http://localhost:5002/predict/uma/rf/DL%20-%20AverageThput%20(Kbps)?experimentid=499&measurement=Throughput_Measures&drop_feature=DL%20-%20MaximumThput%20(Kbps)&drop_feature=DL%20-%20MinimumThput%20(Kbps)&remove_outliers=mad-->
